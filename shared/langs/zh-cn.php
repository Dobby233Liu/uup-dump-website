...
$s['build'] = '内部版本';
$s['arch'] = '体系结构';
$s['ring'] = '环'; // could be 通道/圈/Ring？ 
				   // e.g. Slow Ring MS tl: 慢圈. https://insider.windows.com/zh-cn/how-to-pc/#about-rings
				   // one of a 环 tl origin: https://docs.microsoft.com/zh-cn/windows-insider/flight-hub/
$s['updateid'] = '更新 ID';
$s['update'] = '更新名称';
$s['lang'] = '语言';
$s['edition'] = '版本';
...
$s['sourceCode'] = '源代码';
$s['menu'] = '菜单';
$s['websiteDesc'] = '可以轻松地从 Windows Update 服务器下载 UUP 文件。此项目与 Microsoft Corporation 无关。';
$s['notAffiliated'] = '此项目与 Microsoft Corporation 无关。Windows 是 Microsoft Corporation 的注册商标。';
$s['copyright'] = '© %d %s 和贡献者们。'; //© 2019 whatever127 和贡献者们。
$s['selectLanguage'] = '请选择您的语言';
...
$s['weFoundBuilds'] = '鉴于您的查询，我们找到了 <b>%d</b> 个内部版本。'; // 鉴于您的查询，我们找到了 <b>692</b> 个内部版本。
...
$s['latestDoYouWantKnown'] = '您想通过浏览已知内部版本列表继续吗？';
...
$s['chooseLang'] = '选择语言';
$s['chooseLangDesc'] = '选择您想要的语言';
$s['allLangs'] = '全语言';
$s['selLangFiles'] = '文件';
$s['allFiles'] = '全部文件';
$s['wubOnly'] = '仅限 WindowsUpdateBox';
$s['updateOnly'] = '仅更新';
$s['selectLangInfoText1'] = '点击 <i>下一步</i> 按钮以选择您要下载的版本。';
...
$s['chooseEditionDesc'] = '选择您想要的版本';
$s['allEditions'] = '全版本';
$s['selectEditionInfoText'] = '点击 <i>下一步</i> 按钮以打开所选内容的版本摘要页面。';
$s['additionalEditionsInfo'] = '如果您需要可在右侧表格中找到的其他版本，请选择指定的所需版本，然后单击 <i>下一步</i>。在摘要页面上，您可以在相应的下载选项下选择所需的其他版本。';

//download.php
$s['summary'] = '摘要';
$s['summaryDesc'] = '请检查您的选择并选择下载方式';
...
$s['summaryOfSelection'] = '来自您所选择的版本摘要';
$s['browseList'] = '浏览文件列表';
...
$s['systemWithAdk'] = '安装了 Windows 10 评估和部署工具包的 %s'; // 安装了 Windows 10 评估和部署工具包的 Windows 7
$s['additionalUpdates'] = '其他更新';
$s['additionalUpdatesDesc'] = '此 UUP 集将在转换过程中会集成其他更新，这将会显著地增加创建时间。';
$s['browseUpdatesList'] = '浏览更新列表';
$s['selectDownloadOptions'] = '请选择您的下载选项';
$s['selectDownloadOptionsSub'] = '配置您下载选择项的方法'; // qps-ploc line for reference: Ƈǿƞƒīɠŭřḗ ħǿẇ ẇǿŭŀḓ ẏǿŭ ŀīķḗ ŧǿ ḓǿẇƞŀǿȧḓ ẏǿŭř şḗŀḗƈŧīǿƞ
...
$s['fileRenamingScriptDesc2'] = '只需将下面表格中的内容复制到带有 <code>cmd</code> 扩展名的新文件，并将其放在带有下载文件的文件夹中运行即可。';
$s['sha1File'] = 'SHA-1 校验和文件';
$s['sha1FileDesc'] = '您可以使用此文件快速验证文件是否已正确下载。';
$s['aria2NoticeTitle'] = '使用 aria2 选项创建下载';
$s['aria2NoticeText1'] = '使用 aria2 选项下载可创建需要下载的存档， 下载的存档包含实现所选任务所需的所有文件。';
$s['aria2NoticeText2'] = '要开始下载过程，请使用适用于您的平台的脚本：';
$s['aria2NoticeText3'] = 'Aria2 是一个开源项目，您可以在这里找到它：%s。'; //Aria2 is an open source project. You can find it here: https://aria2.github.io/.
$s['aria2NoticeText4'] = 'UUP 转换脚本（Windows 版本）'./**已**/'由 %s 创建。'; // UUP 转换脚本（Windows 版本）由 abbodi1406 创建。
$s['aria2NoticeText5'] = 'UUP 转换脚本（Linux 版本）是开源的。您可以在这里找到它：%s。'; //UUP Conversion script (Linux version) is open source. You can find it here: https://github.com/uup-dump/converter.

//findfiles.php
$s['findFilesIn'] = '在 %s 中查找文件'; //Find files in Windows 10 Insider Preview 18890.1000 (rs_prerelease) amd64
$s['fileRenamingScriptDescFindFiles'] = '如果要快速重命名在此页面下载的文件，可以生成重命名脚本，此脚本将自动为您执行此操作。';
$s['fileRenamingScriptGenW'] = '生成重命名脚本（Windows）';
$s['fileRenamingScriptGenL'] = '生成重命名脚本（Linux）';
$s['searchForFiles'] = '查找文件……';
$s['weFoundFiles'] = '鉴于您的查询，我们找到了 <b>%d</b> 个文件。'; //We have found <b>692</b> files for your query.

//Error pages
$s['error'] = '错误';
$s['requestNotSuccessful'] = '请求未成功';
$s['anErrorHasOccurred'] = '在尝试处理您的请求时发生错误。';
...
$s['arm64Warning'] = '您选择的 ARM64 版本 <b>仅与基于 ARM64 的设备兼容</b> ，并且不适用于常规基于 Intel 或 AMD 的 PC。对于 <b>64 位</b>的 PC，请使用 <b>amd64</b> 版本。对于 <b>32 位</b> PC，请使用 <b>x86</b> 版本。如果您确定目标设备是基于 ARM64 的，则可以放心地忽略此消息。';
...
$s['error_RATE_LIMITED'] = '您受到了限制，请在几秒钟后重试。';
$s['error_UNSPECIFIED_VE'] = '您尚未选择任何其他版本。如果不想创建其他版本，请选择 <i>使用 aria2 下载并转换</i> 选项。';
